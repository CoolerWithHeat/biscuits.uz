...
const AddedQuantity = ({quantity})=> <div className="quantity">
...
const Thumbnail = ({url})=> <div className="image_window">
                                <img className="product_image" src={url} alt=""/>
                            </div>;

const Category = ({is})=>   <div className="product_type">
                                <small>{is}</small>
                            </div>;

const Title = ({is})=>      <div className="product_title">
                                <h5>{is}</h5>
                            </div>;

const Price = ({is})=>     <div className="product_price">
                                <p>${is}</p>
                            </div>;
