...
import secondary from '../assets/images/past-section.jpg';
                ...
                <div className="container py-5">
                    <div className="row justify-content-start">
                        <div className="col-lg-8 text-center text-lg-start">
                            ...
                            <RedirectionButton path="/React/Main/"/>
                        </div>
                    </div>
                </div>
            </div>
...
const MainContentHeader = ()=>  <div className="section-title position-relative text-center mx-auto mb-5 pb-3" style={{maxWidth: '600px'}}>
                                    ...
                                    <h1 className="display-4 text-uppercase">Вы видите приложение React!</h1>
                                </div>
...
function MainContent(){
    useEffect(() => {
        ...
        addStylesheet('https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600&family=Oswald:wght@500;600;700&family=Pacifico&display=swap')
        addStylesheet('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.10.0/css/all.min.css')
      }, []);
                    ...
                    <div className="row gx-5">
                        <div className="col-lg-5 mb-5 mb-lg-0" style={{minHeight: '400px'}}>
                            <div className="position-relative h-100">
                                <img className="position-absolute w-100 h-100" src={secondary} style={{objectFit: 'cover'}}/>
                            </div>
                        </div>
                        <div className="col-lg-6 pb-5">
                            <ContentDescription type='h4' size='4' content="Это веб-приложение, написанное на Vite/React, Redux, React-Router."/>
                            <ContentDescription 
                                type='p' 
                                size='5' 
